...
class DosenPageController extends Controller
{
    ...
    public function dashboard_dosen()
    {
        ...
        // $jurusan_id = $dosen->id_jurusan;
        // $nilai_magang_ext = NilaiMagangExt::where('validasi_kaprodi', 'Belum Disetujui')
        //     ->whereIn('id_mahasiswa', function ($query) use ($jurusan_id) {
        //         $query->select('id')->from('mahasiswas')->where('id_jurusan', $jurusan_id)->whereExists(function ($query) {
