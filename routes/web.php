...
// Route::get('/formaploudtranskp', function () {
//     return view('pages.form-aploud.formaploudtranskp');
// });

Route::get('/form-uploud-transkip', [TranskipNilai::class, 'form_uploud_transkip'])->name('transkip.mahasiswa.page');
