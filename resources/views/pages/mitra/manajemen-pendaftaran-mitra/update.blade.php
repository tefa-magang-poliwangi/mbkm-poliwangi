                ...
                <div class="card-body">
                    <form action="{{ route('formulir.mitra.update', $mitra->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            is-invalid
                        @enderror"
                                name="update_nama" value="{{ $mitra->nama }}">
                            @error('update_nama')
                        ...
                        <div class="form-group">
                            ...
                            <select
                                class="form-control @error('update_sektor_industri')
                                is-invalid
                            @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <select
                                class="form-control @error('update_kategori')
                                is-invalid
                            @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_alamat" type="text"
                                class="form-control @error('update_alamat')
                            is-invalid
                        @enderror"
                                name="update_alamat" value="{{ $mitra->alamat }}">
                            @error('update_alamat')
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_link_website" type="text"
                                class="form-control @error('update_link_website')
                            is-invalid
                        @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_no_telephone" type="text"
                                class="form-control @error('update_no_telephone')
                            is-invalid
                        @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_email" type="text"
                                class="form-control @error('update_email')
                            is-invalid
                        @enderror"
                                name="update_email" value="{{ $mitra->email }}">
                            @error('update_email')
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_password" type="password"
                                class="form-control @error('update_password')
                            is-invalid
                        @enderror"
                                name="update_password" value="{{ $mitra->password }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_password_konfirmasi" type="password"
                                class="form-control @error('update_password_konfirmasi')
                            is-invalid
                        @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('update_status') is-invalid @enderror" id="update_status"
                                name="update_status">
