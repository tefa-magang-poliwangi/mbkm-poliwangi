    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('manajemen.lowongan.mitra.update', [$id_mitra, $lowongan->id]) }}" method="POST">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input id="jumlah_lowongan" type="number"
                                class="form-control @error('jumlah_lowongan')
                                is-invalid
                            @enderror"
                                name="jumlah_lowongan" value="{{ $lowongan->jumlah_lowongan }}" placeholder="Jumlah Lowongan">
                        ...
                        <div class="form-group">
                            ...
                            <input id="deskripsi" type="text"
                                ...
                                is-invalid
                            @enderror"
                                name="deskripsi" value="{{ $lowongan->deskripsi }}" placeholder="Masukkan Deskripsi">
                            @error('deskripsi')
                        ...
                        <div class="form-group">
                            ...
                            <input id="tanggal_dibuka" type="date"
                                ...
                                is-invalid
                            @enderror"
                                name="tanggal_dibuka" value="{{ $lowongan->tanggal_dibuka }}" placeholder="Masukkan Tanggal Dibuka">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tanggal_ditutup" type="date"
                                ...
                                is-invalid
                            @enderror"
                                name="tanggal_ditutup" value="{{ $lowongan->tanggal_ditutup }}" placeholder="Masukkan Tanggal Ditutup">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tanggal_magang_dimulai" type="date"
                                ...
                                is-invalid
                            @enderror"
                                name="tanggal_magang_dimulai" value="{{ $lowongan->tanggal_magang_dimulai }}" placeholder="Masukkan Tanggal Magang Dimulai">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tanggal_magang_berakhir" type="date"
                                ...
                                is-invalid
                            @enderror"
                                name="tanggal_magang_berakhir" value="{{ $lowongan->tanggal_magang_berakhir }}" placeholder="Masukkan Tanggal Magang Berakhir">
