                                                    ...
                                                    <form
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div id="update_no_telp" class="form-text text-danger">
                                                                    {{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="update_password" class="control-label">Ubah
                                                                Password</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="update_password_confirmation"
                                                                ...
                                                                Password</label>
                                                            <div class="input-group mb-3">
                                                                <input id="update_password_confirmation" type="password"
                                                                    class="form-control @error('update_password_confirmation') is-invalid @enderror"
                                                                    name="update_password_confirmation" tabindex="2"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input id="create_password" type="password"
                            class="form-control @error('create_password') is-invalid @enderror" name="create_password"
