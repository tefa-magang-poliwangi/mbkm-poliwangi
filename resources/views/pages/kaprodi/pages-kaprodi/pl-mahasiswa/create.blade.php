...
@section('title')
    <title>Tambah Dosen Pembimbing Lapang | MBKM Poliwangi</title>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex mb-2">
                                <h5 class="justify-start text-theme">Tambah Dosen Pembimbing Lapang</h5>
                            </div>
                        </div>

                        {{-- Form Checklist Peserta Kelas --}}
                        <form action="{{ route('manajemen.dosen.pl.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row d-flex justify-content-start mt-3">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <a href="{{route('manajemen.dosen.pl.index')}}" class="btn btn-cancel">Back</a>
                                </div>
                            </div>
                        </form>
