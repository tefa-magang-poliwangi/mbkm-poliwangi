...
@section('title')
    <title>Profil Dosen Wali | MBKM Poliwangi</title>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex">
                                <div class="my-auto mx-auto">
                                    @foreach ($dosen->user->getRoleNames() as $role)
                                        <h5>{{ $role }}</h5>
                                    @endforeach
            ...
            <div class="col-12 col-md-12 col-lg-7">
                <div class="card card-hover">
                    <div class="card-body">
                        ...
                        <div class="px-3 pt-4">
                            <form action="{{ route('profil.dosen.wali.update', $dosen->id) }}" method="post">
                                @method('put')
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="no_telp" name="no_telp"
                                            ...
                                            placeholder="Nomor telepon" value="{{ $dosen->no_telp }}" pattern="[0-9]*">
                                        @error('no_telp')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="username" name="username"
                                            ...
                                            placeholder="Username akun" value="{{ $dosen->user->username }}">
                                        @error('username')
