                    ...
                    <div class="card card-primary card-hover rounded">
                        <div class="card-body">
                            <div class="pb-3 pt-1">
                                ...
                                <small class="text-muted">Login sebagai dosen</small>
                            </div>

                            <form action="{{ route('do.login.dosen') }}" method="POST" class="needs-validation">
                                @csrf
                        ...
                        <div class="col-3 d-flex">
                            <a href="{{ route('login.dosen.page') }}" class="menu-none-decoration">
                                <div class="card card-hover text-center p-3 mx-auto card-login-option bg-theme">
                                    <i class="fas fa-graduation-cap fa-lg text-white" title="Dosen"></i>
                                </div>
                            </a>
                        </div>
                        <div class="col-3 d-flex">
