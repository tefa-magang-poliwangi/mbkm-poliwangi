...
@section('title')
    <title>Manajemen Angka Mutu | MBKM Poliwangi</title>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex mb-4">
                                <h5 class="justify-start my-auto text-theme">Manajemen Profil Angka Mutu</h5>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex mb-4">
                                <button class="btn btn-primary ml-auto" data-toggle="modal" data-target="#createModal">
                                    <i class="fa-solid fa-plus"></i> &ensp;
                                    Tambah Profil Angka Mutu
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($profil_angka_mutu as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('manajemen.detail.angka.mutu.show', $data->id) }}"
                                                    ...
                                                    <td class="text-center" width="15%">
                                                        @if ($data->status == 'Aktif')
                                                            <a href="{{ route('manajemen.angka.mutu.update', $data->id) }}"
                        ...
                        {{-- Modal Tambah Profil Angka Mutu Baru --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="createModal">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambah Profil Angka Mutu Baru</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form action="{{ route('manajemen.angka.mutu.store') }}" method="POST">
                                        @csrf
