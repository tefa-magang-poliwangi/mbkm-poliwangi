                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#" class="btn btn-danger ml-auto"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                                @php
                                $no++;
                ...
                <form action="{{ route('manajemen.kaprodi.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input id="periode_mulai" type="date" class="form-control @error('periode_mulai')
                                is-invalid
                            @enderror" name="periode_mulai" placeholder="Masukkan Tanggal Mulai">
                            @error('periode_mulai')
                        ...
                        <div class="form-group">
                            ...
                            <input id="periode_akhir" type="date" class="form-control @error('periode_akhir')
                                is-invalid
                            @enderror" name="periode_akhir" placeholder="Masukkan Tanggal Akhir">
                            @error('periode_akhir')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('id_dosen')
                                        is-invalid
                                    @enderror" id="id_dosen" name="id_dosen">
