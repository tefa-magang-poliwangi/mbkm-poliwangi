...
@section('content')
    <div class="container-fluid" style="padding-top: 5%">
        <div class="d-flex justify-content-between">
            <strong class="h3">Kriteria</strong>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card border-0">
                    <div class="card-header bg-white border-0 px-2">
                        ...
                        <div class="col-6 d-flex">
                            <div class="ml-auto">
                                <button type="button" class="btn btn-cancel">Kembali</button>
                                <button class="btn btn-primary ml-auto"><i class="fa-solid fa-plus"></i> &ensp; Tambah
                                    Periode</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-borderless rounded" id="table-1"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Aksi <span class="badge bg-primary text-white"></span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    {{-- Modal Update --}}
                                    <div class="modal fade" tabindex="-1" role="dialog" {{-- id="updateModal{{ $data->id }}"> --}} <div
                                        ...
                                        <div class="modal-content">
                                            ...
                                            {{-- <form action="{{ route('data.periode.update', $data->id) }}" method="POST"> --}}
                                            @method('put')
                                            @csrf
