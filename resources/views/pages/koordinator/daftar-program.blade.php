...
@section('title')
    <title>Daftar Program MBKM | MBKM Poliwangi</title>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex mb-4">
                                <h5 class="justify-start my-auto text-theme">Daftar Program MBKM</h5>
                            </div>
                        </div>
                                            ...
                                            @foreach ($jenis_program as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('koordinator.daftar.prodi', $data->id) }}"
