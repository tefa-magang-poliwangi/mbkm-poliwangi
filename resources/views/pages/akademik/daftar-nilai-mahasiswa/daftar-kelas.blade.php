...
@section('title')
<title>Daftar Kelas | MBKM Poliwangi</title>
@endsection
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('akademik.daftar.mahasiswa', $data->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="1" {{ $data->tingkat_kelas == '1' ?
                                                                        'selected' : '' }}>
                                                                        1</option>
                                                                    <option value="2" {{ $data->tingkat_kelas == '2' ?
                                                                        'selected' : '' }}>
                                                                        2</option>
                                                                    <option value="3" {{ $data->tingkat_kelas == '3' ?
                                                                        'selected' : '' }}>
                                                                        3</option>
                                                                    <option value="4" {{ $data->tingkat_kelas == '4' ?
                                                                        'selected' : '' }}>
                                                                        4</option>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    id="update_abjad_kelas" name="update_abjad_kelas">
                                                                    <option value="">Pilih Abjad Kelas
                                                                    </option>
                                                                    <option value="A" {{ $data->abjad_kelas == 'A' ?
                                                                        'selected' : '' }}>
                                                                        A</option>
                                                                    <option value="B" {{ $data->abjad_kelas == 'B' ?
                                                                        'selected' : '' }}>
                                                                        B</option>
                                                                    <option value="C" {{ $data->abjad_kelas == 'C' ?
                                                                        'selected' : '' }}>
                                                                        C</option>
                                                                    <option value="D" {{ $data->abjad_kelas == 'D' ?
                                                                        'selected' : '' }}>
                                                                        D</option>
                                                                    <option value="E" {{ $data->abjad_kelas == 'E' ?
                                                                        'selected' : '' }}>
                                                                        E</option>
                                                                    <option value="F" {{ $data->abjad_kelas == 'F' ?
                                                                        'selected' : '' }}>
                                                                        F</option>
                                                                    <option value="G" {{ $data->abjad_kelas == 'G' ?
                                                                        'selected' : '' }}>
                                                                        G</option>
                                                                    <option value="H" {{ $data->abjad_kelas == 'H' ?
                                                                        'selected' : '' }}>
                                                                        H</option>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{ $data->id_prodi
                                                                        == $item->id ? 'selected' : '' }}>
                                                                        {{ $item->nama }}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{ $data->id_periode
                                                                        == $item->id ? 'selected' : '' }}>
                                                                        {{ $item->semester }} -
                                                                        {{ $item->tahun }}</option>
                                                                    @endforeach
