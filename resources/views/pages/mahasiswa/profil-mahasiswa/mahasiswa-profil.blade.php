...
@section('title')
    <title>Profil Mahasiswa | MBKM Poliwangi</title>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex">
                                <div class="my-auto mx-auto">
                                    ...
                                    <span>{{ $mahasiswa->prodi->nama }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-12 col-lg-7">
                <div class="card card-hover">
                    <div class="card-body">
                        ...
                        <div class="px-3 pt-4">
                            <form action="{{ route('profil.mahasiswa.update', $mahasiswa->id) }}" method="post">
                                @method('put')
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="angkatan">Angkatan</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="angkatan" name="angkatan"
                                            class="form-control  @error('angkatan') is-invalid @enderror"
                                            placeholder="Angkatan" pattern="[0-9]*" value="{{ $mahasiswa->angkatan }}">
                                        @error('angkatan')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="no_telp" name="no_telp"
                                            ...
                                            placeholder="No telepon" pattern="[0-9]*" value="{{ $mahasiswa->no_telp }}">
                                        @error('no_telp')
