                    ...
                    <div class="px-3 pt-4">
                        <form action="{{ route('manajemen.profil.plmitra.update', $plmitra->id) }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="nama" name="nama" class="form-control  @error('nama') is-invalid @enderror" placeholder="Nama lengkap" value="{{ $plmitra->nama }}">
                                    @error('nama')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="no_telp" name="no_telp" class="form-control  @error('no_telp') is-invalid @enderror" placeholder="No telepon" pattern="[0-9]*" value="{{ $plmitra->no_telp }}">
                                    @error('no_telp')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="email" name="email" class="form-control  @error('email') is-invalid @enderror" placeholder="Alamat email" value="{{ $plmitra->email }}">
                                    @error('email')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Konfirmasi password baru">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
